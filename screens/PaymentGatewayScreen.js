    ...
    <SafeAreaView style={[s.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[s.header, { backgroundColor: colors.background }]}>
        <TouchableOpacity
          ...
          style={[s.backButton, { backgroundColor: colors.primaryContainer }]}
        >
          <Ionicons name="chevron-back" size={22} color={colors.primary} />
        </TouchableOpacity>
        <Text style={[s.headerTitle, { color: colors.primary }]}>Payment Gateway</Text>
      ...
      <WebView
        ...
        renderLoading={() => (
          <View style={[s.loadingContainer, { backgroundColor: colors.surface }]}>
            <ActivityIndicator size="large" color={colors.primary} />
            <Text style={[s.loadingText, { color: colors.textSecondary }]}>Loading Payment Gateway...</Text>
          </View>
        )}
      />
    </SafeAreaView>
